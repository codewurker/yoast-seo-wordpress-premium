...
/**
 * Represents the task for completing the orphaned content workout.
 */
class Orphaned_Workout extends Abstract_Task {
	...
	public function get_is_completed(): bool {
		...
		if ( ! isset( $workouts_data['orphaned'], $workouts_data['orphaned']['finishedSteps'] ) || ! \is_array( $workouts_data['orphaned'] ) ) {
			return false;
		}

		return \count( $workouts_data['orphaned']['finishedSteps'] ) === 3;
	}
	...
	public function get_link(): ?string {
		return \self_admin_url( 'admin.php?page=wpseo_workouts#orphaned' );
	}
